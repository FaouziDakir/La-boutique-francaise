...
class __TwigTemplate_7ea063518eac564ffd106d280c3fbbb96988986bd44c769446d79275334365e8 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">
    ...
    <div class=\"col-md-7 my-auto\">
      ...
      <p>";
        ...
        <a href=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add-to-cart", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 20, $this->source); })()), "id", [], "any", false, false, false, 20)]), "html", null, true);
        echo "\" class=\"btn btn-primary\">Ajouter au panier</a>
      </div>
    </div>
    <hr>
    <h3>No meilleures ventes</h3>
    ...
    <div class=\"row\">
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["product"]) {
          ...
          ";
            // line 29
            $this->loadTemplate("product/single_product.html.twig", "product/show.html.twig", 29)->display($context);
            // line 30
            echo "        </div>
      ";
            ++$context['loop']['index0'];
  ...
  ";
    ...
    {
        return array (  169 => 32,  154 => 30,  152 => 29,  149 => 28,  132 => 27,  122 => 20,  117 => 18,  111 => 15,  107 => 14,  103 => 13,  95 => 10,  90 => 7,  80 => 6,  59 => 3,  36 => 1,);
    }
...
{% block title %}{{ product.name}}
  - La boutique française{% endblock %}
...
{% block content %}
  ...
  {% endblock %}
", "product/show.html.twig", "C:\\Users\\brico\\Desktop\\laboutiquefrancaise\\templates\\product\\show.html.twig");
    }
}
