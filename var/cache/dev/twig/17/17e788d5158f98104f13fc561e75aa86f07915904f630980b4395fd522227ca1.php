...
class __TwigTemplate_20af71303ccb453a3458235e61633b9ed7a4b9a65a53c46236fa702d0c58c41b extends Template
{
    private $source;
    private $macros = [];
...
<p>Bonjour <strong>{{order.user.firstname}}</strong>, <br>
Nous vous remercions pour votre commande (n°<strong>{{order.reference}}</strong>). <br>
Une confirmation vous a été envoyée par mail : <strong>{{order.user.email}}</strong>.
...
{% endblock %}
", "order_success/index.html.twig", "C:\\Users\\brico\\Desktop\\laboutiquefrancaise\\templates\\order_success\\index.html.twig");
    }
}
