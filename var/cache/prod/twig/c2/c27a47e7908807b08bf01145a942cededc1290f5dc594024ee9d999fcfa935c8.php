...
class __TwigTemplate_793b60618326f35a6519283061d199ecfd92d084065a7cad22c936fbcd0579df extends Template
{
    private $source;
    private $macros = [];
...
($context["__internal_d7c80f39795f088853c77885d62e7f090c4e77586efd3b4edce3153ad2d26e75"] ?? null))) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("login_page.username", [], "EasyAdminBundle")));
        // line 14
        echo "    ";
...
($context["__internal_d7c80f39795f088853c77885d62e7f090c4e77586efd3b4edce3153ad2d26e75"] ?? null))) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("login_page.password", [], "EasyAdminBundle")));
        // line 15
        echo "    ";
...
($context["__internal_d7c80f39795f088853c77885d62e7f090c4e77586efd3b4edce3153ad2d26e75"] ?? null))) : ($this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("login_page.sign_in", [], "EasyAdminBundle")));
        // line 16
        echo "
    <div class=\"login-wrapper\">
        ...
        echo "\" value=\"";
        echo twig_escape_filter($this->env, (((isset($context["target_path"]) || array_key_exists("target_path", $context))) ? (_twig_default_filter(($context["target_path"] ?? null), (((isset($context["ea"]) || array_key_exists("ea", $context))) ? ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(twig_get_attribute($this->env, $this->source, ($context["ea"] ?? null), "dashboardRouteName", [], "any", false, false, false, 48))) : ("/")))) : ((((isset($context["ea"]) || array_key_exists("ea", $context))) ? ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(twig_get_attribute($this->env, $this->source, ($context["ea"] ?? null), "dashboardRouteName", [], "any", false, false, false, 48))) : ("/")))), "html", null, true);
        echo "\" />
...
";
    ...
    {
        return new Source("", "@EasyAdmin/page/login.html.twig", "C:\\Users\\brico\\Desktop\\laboutiquefrancaise\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\page\\login.html.twig");
    }
}
