...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 28 juin 2021 à 15:42
...
(4, 'faouzi.dakir@hotmail.com', '[]', '$argon2id$v=19$m=65536,t=4,p=1$U1VyYkw5cVgyMEhuTVJVcA$kcQCl/eVpaSKiHnVmULm8El2V+8mDWbiHYpwkhlFXAg', 'Faouzi', 'Dakir'),
(5, 'fouz@gmail.com', '[]', '$argon2id$v=19$m=65536,t=4,p=1$d3BzOTBTN0VTamNPaVB5Tg$b/m3TTWOqbZzs0bTj7Dh9ayoW6mQcoge9cIuYoLpF+I', 'Faouzi', 'Dakir'),
(8, 'l.a.-noire@hotmail.com', '[\"ROLE_ADMIN\"]', '$argon2id$v=19$m=65536,t=4,p=1$ZGlGMXMzcy4wZDJaUFQ3cQ$2HCILNR1N/ckcUrVWdWjSuIfySKecs9eVR/JzQr92v8', 'Faouzi', 'Dakir');
